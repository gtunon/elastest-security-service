...
[![Build Status](https://ci.elastest.io/jenkins/buildStatus/icon?job=elastest-security-service/EssTestProject)](https://ci.elastest.io/jenkins/job/elastest-security-service/ess)
